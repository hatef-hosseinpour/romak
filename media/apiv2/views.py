...
from .serializers import DeviceSerializer, OrganizationSerializer, EngineRoomFeatureSerializer, LocationSerializer
...
class DeviceAPIView(viewsets.ViewSet):
    ...
    def get_option_for_insert(self, request):
        ...
        ################################################
            ...
            options['administration'] = [{'id': id, 'administration': administration}
                                         for id, administration in administrations]
