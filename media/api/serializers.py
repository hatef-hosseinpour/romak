...
class EnginroomSerializers(serializers.ModelSerializer):
    ...
    location = serializers.CharField(
        source='locationpublicinfo.location', read_only=True)
    province = serializers.CharField(
        source='locationpublicinfo.province', read_only=True)
    city = serializers.CharField(
        source='locationpublicinfo.city', read_only=True)
    phone_number1 = serializers.CharField(
        source='locationpublicinfo.phone_number1', read_only=True)
    phone_number2 = serializers.CharField(
        source='locationpublicinfo.phone_number2', read_only=True)
...
class InstallationInfoSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # @param fields What fields of the EnginroomPublicInfo model do we want to serialize
        # fields = ['id', 'user', 'installer_username', 'enginroom', 'enginroom_name', 'installed_device_model', 'connection_type', 'modem_model',
        #           'has_simcard', 'modem_simcard_number', 'installation_date', 'device_serial_number_image', 'modem_simcard_serial_number_image']
        fields = '__all__'
...
class EnginroomImagesSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'user', 'device', 'images_data', 'image']
