...
urlpatterns = [
    ...
    path('reset_password/<int:pk>', view=resetPasswordFrontView,
         name='front-reset-password'),


    path('event-history/', view=eventHistoryFrontView, name='event-history'),
    path('edit-event-history/<int:pk>', view=editEventHistoryFrontView, name='edit-event-history'),
    path('event-history-list/', view=eventHistoryListFrontView,
    ...
    path('organization-list/', view=organizationListFrontView,
         name='front-organization-list'),
    path('location-list/', view=locationListFrontView,
         name='front-location-list'),
    path('engineroom-feature-list/', view=engineroomFeatureListFrontView,
         name='front-engineroom-feature-list'),
]
